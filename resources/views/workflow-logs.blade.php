            ...
            <table id="global_table" class="table gy-5 gs-7">
                <thead>
                    <tr class="fs-7 fw-bold text-gray-400 border-bottom-0">
                        ...
                        <th class="cursor-pointer px-0 min-w-175px text-start">آخرین عملیات انجام شده</th>
                        <th class="cursor-pointer px-0 min-w-175px text-start">تاریخ و ساعت شروع</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a href="{{route('workflow-log.show',['id' => 1])}}" class="text-gray-800 text-hover-primary fs-6 fw-bolder mb-1">ثبت سفارش</a>
                        </td>
                        <td>
                            <a class="badge badge-warning" href="{{route('workflow-log.show',['id' => 1])}}">در حال انجام</a>
                            <a class="badge badge-danger" href="{{route('workflow-log.show',['id' => 1])}}">متوقف شده</a>
                            <a class="badge badge-success" href="{{route('workflow-log.show',['id' => 1])}}">پایان یافته</a>
                        </td>
                        <td>
                            <a href="{{route('workflow-log.show',['id' => 1])}}">ارسال اطلاعیه سفارش به ادمین</a>
                        </td>
                        <td>
                            <a href="{{route('workflow-log.show',['id' => 1])}}">12/12/1403 23:59</a>
                        </td>
                        <td class="text-end">
                            <a href="{{route('workflow-log.show',['id' => 1])}}" class="btn btn-light btn-sm">
                                ویرایش
                            </a>
                        </td>
                    </tr>
