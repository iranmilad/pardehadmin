        ...
        <div class="card-body">
            <div class="form-group row mb-5 align-items-center">
                ...
                <div class="col-10">
                    <div class="col-10">
                        @php
                            $selectedOrder = [["id"=>$settlementDocument->order->id,"text"=>$settlementDocument->order->id .' '. $settlementDocument->order->customer_name]];
                        @endphp
                        <x-advanced-search type="order" label="" name="order_id" :selected="$selectedOrder" />
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row mb-5 align-items-center">
                ...
                <div class="col-10">
                    <div class="col-10">
                        @php
                            $selectedUser = [["id"=>$settlementDocument->user->id,"text"=>$settlementDocument->user->full_name]];
                        @endphp
                        <x-advanced-search type="user" label="" name="user_id" :selected="$selectedUser" disabled />
                    </div>
                </div>
            </div>
