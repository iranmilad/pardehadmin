            ...
            <div class="card-body">
                <form action="" method="post">
                    ...
                    <div class="form-group row mb-5">
                        ...
                        <div class="col-10">
                            <div>
                                <textarea name="" id="" class="form-control" rows="5">سلام مدیر
سفارش {order_id} ثبت شده است و هم اکنون در وضعیت در انتظار پرداخت می باشد.
...
مبلغ سفارش : {price}
    ...
    <div class="tab-pane fade" id="pills-customer-sms" role="tabpanel" aria-labelledby="pills-customer-sms-tab">پیامک مشتری محتوا</div>
    <div class="tab-pane fade" id="pills-tailor-sms" role="tabpanel" aria-labelledby="pills-tailor-sms-tab">پیامک خیاط محتوا</div>
</div>
@endsection