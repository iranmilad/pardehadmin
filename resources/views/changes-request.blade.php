            ...
            <table id="global_table" class="table gy-5 gs-7">
                <thead>
                    <tr class="fs-7 fw-bold text-gray-400 border-bottom-0">
                        ...
                        <th class="cursor-pointer px-0 min-w-175px text-start">تاریخ درخواست</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a href="{{route('change-request.show',['id' => 1])}}" class="text-gray-800 text-hover-primary fs-6 fw-bolder mb-1">ویرایش قیمت محصول</a>
                        </td>
                        <td>
                            <a href="{{route('change-request.show',['id' => 1])}}">12/12/1403 23:59</a>
                        </td>
                        <td class="text-end">
                            <a href="{{route('change-request.show',['id' => 1])}}" class="btn btn-light btn-sm">
                                مشاهده
                            </a>
                        </td>
                    </tr>
