										...
										<div class="menu-item px-3">
											<div class="menu-content d-flex align-items-center px-3">
												...
												<div class="symbol symbol-50px me-5">
													<img alt="Logo" src="/images/avatar.png" />
												</div>
												<!--end::Avatar-->
												<!--begin::کاربرname-->
												<div class="d-flex flex-column">
													<div class="fw-bold d-flex align-items-center fs-5">فرهاد باقری
													<span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">ادمین</span></div>
													<a href="#" class="fw-semibold text-muted text-hover-primary fs-7">09374039436</a>
												</div>
												<!--end::کاربرname-->
											</div>
										</div>
