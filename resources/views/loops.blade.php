...
@section("toolbar")
<a href="{{route('loop.create.show')}}" class="btn btn-primary">حلقه جدید</a>
@endsection
            ...
            <table id="global_table" class="table gy-5 gs-7">
                <thead>
                    <tr class="fs-7 fw-bold text-gray-400 border-bottom-0">
                        ...
                        <th class="cursor-pointer px-0 min-w-175px text-start">تم</th>
                        <th class="cursor-pointer px-0 min-w-175px text-start">تعداد آیتم ها</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a href="{{route('loop.edit.show',['id' => 1])}}" class="text-gray-800 text-hover-primary fs-6 fw-bolder mb-1">
                                حلقه فروش ویژه
                            </a>
                        </td>
                        <td>
                            <a href="{{route('loop.edit.show',['id' => 1])}}" class="badge badge-primary">فروش ویژه</a>
                            <a href="{{route('loop.edit.show',['id' => 1])}}" class="badge badge-light">ساده</a>
                        </td>
                        <td>
                            <a href="{{route('loop.edit.show',['id' => 1])}}">10</a>
                        </td>
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-info fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="{{route('loop.edit.show',['id' => 1])}}" class="menu-link px-3">
                                        ویرایش
                                    </a>
                                </div>
                                <!--end::Menu item-->
