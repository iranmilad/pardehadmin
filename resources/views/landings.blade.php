...
@section("toolbar")
<a href="{{route('landing.create.show')}}" class="btn btn-primary">لندینگ جدید</a>
@endsection
            ...
            <table id="global_table" class="table gy-5 gs-7">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a href="{{route('landing.edit.show',['id' => 1])}}" class="text-gray-800 text-hover-primary fs-6 fw-bolder mb-1">
                                <img class="tw-size-16 tw-rounded-md" src="/images/1.jpg" alt="">
                                <span class="ms-6">لندینگ 1</span>
                            </a>
                        </td>
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-info fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="{{route('landing.edit.show',['id' => 1])}}" class="menu-link px-3">
                                        ویرایش
                                    </a>
                                </div>
                                <!--end::Menu item-->
