...
@section("toolbar")
<a href="{{route('check.create.show')}}" class="btn btn-primary">ایجاد پلن</a>
@endsection
            ...
            <table id="installments_plans_table" class="table gy-5 gs-7">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a href="{{route('installments.plan.show',['id' => 1])}}" class="text-gray-800 text-hover-primary fs-6 fw-bolder mb-1">اقساط 5 ماهه</a>
                        </td>
                        <td class="text-end">
                            <a href="{{route('installments.plan.show',['id' => 1])}}" class="btn btn-light btn-sm">
                                ویرایش
                            </a>
                        </td>
                    </tr>
