...
<div class="card mb-5 mb-xl-10">
    <div class="card-body pt-9 pb-0">
                ...
                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                    ...
                    <div class="d-flex my-4">
                        <a href="#" class="btn btn-sm btn-light me-2" id="kt_user_follow_button">
                            ...
                            <span class="indicator-label">غیر فعال کردن</span>
                            <!--end::Indicator label-->
                        </a>
                        <!--begin::Menu-->
                        <div class="me-0">
                        ...
                        <div class="d-flex flex-wrap">
                            ...
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="fs-3 fw-bold counted">2,000,000</div>
                                </div>
                                <!--end::شماره کارت-->
                                <!--begin::Tags-->
                            ...
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="fs-3 fw-bold counted">5 / 10</div>
                                </div>
                                <!--end::شماره کارت-->
                                <!--begin::Tags-->
                                <div class="fw-semibold fs-6 text-gray-400">چک های پرداخت شده</div>
                                <!--end::Tags-->
                            </div>
                            <!--end::Stat-->
                            <!--begin::Stat-->
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="fs-3 fw-bold counted" data-kt-countup="true" data-kt-countup-value="80" data-kt-initialized="1">20,000,000</div>
                                </div>
                                <!--end::شماره کارت-->
                                <!--begin::Tags-->
        ...
        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
            ...
            <!--begin::Nav item-->
            <li class="nav-item mt-2">
                <a class="nav-link text-active-primary ms-0 me-10 py-5" href="{{ route('checks.index.show',['id' => 1]) }}">چک ها</a>
            </li>
            <!--end::Nav item-->
            <!--begin::Nav item-->
            <li class="nav-item mt-2">
                <a class="nav-link text-active-primary ms-0 me-10 py-5" href="{{ route('installments.index.show',['id' => 1]) }}">سررسید اقساط</a>
            </li>
            <!--end::Nav item-->
            <!--begin::Nav item-->
            <li class="nav-item mt-2">
