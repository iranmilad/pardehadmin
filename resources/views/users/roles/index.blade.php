            ...
            <table id="global_table" class="table gy-5 gs-7">
                <thead>
                    <tr class="fs-7 fw-bold text-gray-400 border-bottom-0">
                        ...
                        <th class="cursor-pointer px-0 text-start">نام نمایشی</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('users.roles.edit', ['id' => $role->id]) }}" class="text-gray-800 text-hover-primary fs-6 fw-bolder">{{ $role->display_name }}</a>
                        </td>
                        <td>
