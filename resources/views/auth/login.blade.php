...
@section('content')
<form class="w-md-350px  mx-auto" method="post" action="{{ route('login') }}">
    @csrf
    <div class="fv-row text-start">
        <div class="row gap-5">
            ...
            <div class="fv-row mb-3 mt-3">
                <input autocomplete="off" type="text" name="email" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 {{ $errors->has('email') ? 'is-invalid' : '' }}" placeholder="نام کاربری یا ایمیل">
            ...
            <div class="fv-row mb-3">
                <input autocomplete="off" type="text" name="password" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 {{ $errors->has('password') ? 'is-invalid' : '' }}" placeholder="گذرواژه">
                <div class="fv-plugins-message-container invalid-feedback">
            ...
            <div class="d-grid mb-5">
                <a href="{{ route('forgetpass') }}">فراموشی رمز عبور</a>
            </div>
            ...
            <div class="d-grid mb-5">
                <a href="{{ route('signup') }}" class="btn btn-light">
