...
@section("toolbar")
<a href="{{route('score-group.create.show')}}" class="btn btn-primary">افزودن گروه جدید</a>
@endsection
            ...
            <table id="global_table" class="table gy-5 gs-7">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a href="{{route('score-group.edit.show',['id' => 1])}}" class="text-gray-800 text-hover-primary fs-6 fw-bolder">گروه A+</a>
                        </td>
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="{{ route('score-group.edit.show', ['id' => 1]) }}" class="menu-link px-3">
                                        ویرایش
                                    </a>
                                </div>
                                <!--end::Menu item-->
