...
@section("toolbar")
<a href="{{route('attribute.create.show')}}" class="btn btn-primary">قطعه کد جدید</a>
@endsection
            ...
            <table id="snippets_table" class="table gy-5 gs-7">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a href="{{route('snippet.show',['id' => 1])}}" class="text-gray-800 text-hover-primary fs-6 fw-bolder mb-1">متاتگ</a>
                        </td>
                        <td>
                            <a class="badge badge-dark" href="{{route('snippet.show',['id' => 1])}}">ابتدای هدر</a>
                        </td>
                        <td>
                            <span>1</span>
                        </td>
                        <td class="text-end">
                            <a href="{{route('snippet.show',['id' => 1])}}" class="btn btn-light btn-sm">
                                ویرایش
                            </a>
                        </td>
                    </tr>
